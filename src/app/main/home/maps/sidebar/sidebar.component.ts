...
import { UnitInfoSidebarService } from './sidebar.service';
import { FuseMatchMediaService } from '@fuse/services/match-media.service';
import { FuseConfigService } from '@fuse/services/config.service';

@Component({
    selector: 'unitinfo-sidebar',
    templateUrl: './sidebar.component.html',
    styleUrls: ['./sidebar.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class UnitInfoSidebarComponent implements OnInit, OnDestroy {
    // Name
    @Input()
    name: string;
     ...
     * @param {FuseSidebarService} _unitinfoSidebarService
    ...
    constructor(
        ...
        private _fuseSidebarService: UnitInfoSidebarService,
