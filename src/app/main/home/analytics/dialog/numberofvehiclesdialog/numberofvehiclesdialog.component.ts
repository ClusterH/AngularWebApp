...
@Component({
    selector: 'clip-numberofvehiclesdialog',
    templateUrl: './numberofvehiclesdialog.component.html',
    styleUrls: ['./numberofvehiclesdialog.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class NumberOfVehiclesDialogComponent implements OnInit, OnDestroy {
    detail: any; flag: any;
    displayedColumns = ['unit', 'company', 'lastreport', 'odometer', 'ign'];
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<NumberOfVehiclesDialogComponent>,
    ...
    actionPageIndexbutton(pageIndex: number) {
        this.dataSource.loadVehicles(pageIndex, this.paginator.pageSize, this.sort.active, this.sort.direction, "clip_numberofvehicles_detail");
    }

    navigatePageEvent() {
        this.paginator.pageIndex = this.dataSource.page_index - 1;
        this.dataSource.loadVehicles(this.paginator.pageIndex, this.paginator.pageSize, this.sort.active, this.sort.direction, "clip_numberofvehicles_detail");
    }
