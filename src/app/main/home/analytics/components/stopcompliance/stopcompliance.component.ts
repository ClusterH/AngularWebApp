...
export class StopcomplianceComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.clipsservice.clip_mileage('clip_RouteCompliance').then(res => {
            this.clipsservice.clip_stopcomplianceChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(res => {
