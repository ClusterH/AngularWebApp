...
export class VehiclesDataSource extends DataSource<any> {
    ...
    loadVehicles(pageindex: number, pagesize: number, orderby: string, orderdirection: string, method: string) {
        this.loadingSubject.next(true);
        // use pipe operator to chain functions with Observable type
        this.clipService.getVehicles(pageindex, pagesize, orderby, orderdirection, method)
            .pipe(
                catchError(() => of([])),
                ...
                this.clipService.vehicleList = result.TrackingXLAPI.DATA;
                this.vehiclesSubject.next(this.clipService.vehicleList);
