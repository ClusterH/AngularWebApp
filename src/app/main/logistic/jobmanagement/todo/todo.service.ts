...
import { Todo } from 'app/main/logistic/jobmanagement/todo/todo.model';
...
export class TodoService implements Resolve<any>
{
    ...
    setCurrentTodo(id): void
    {
        ...
        if ( tagHandle )
        {
            this._location.go('logistic/todo/tag/' + tagHandle + '/' + id);
        }
        else if ( filterHandle )
        {
            this._location.go('logistic/todo/filter/' + filterHandle + '/' + id);
        }
        else
        {
            this._location.go('logistic/todo/all/' + id);
        }
    }
