...
export class EventsComponent implements OnInit, OnDestroy {
    ...
    selectedFilter() {
        if (this.selected == '') {
            ...
            this.dataSource.loadEvents(this.paginator.pageIndex, this.paginator.pageSize, this.sort.active, this.sort.direction, this.selected, this.filter_string, "maintevent_TList");
        }
    }
