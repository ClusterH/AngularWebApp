...
export class EventDetailDataSource extends DataSource<any>
{
    ...
    loadEventDetail(conncode: string, userid: number, pageindex: number, pagesize: number, name: string, method: string) {
        ...
        .subscribe((result : any) => {
           console.log("method:", method, result);
            ...
            console.log(method, this.eventDetailService.unit_clist_item);
