...
export class EventDetailComponent implements OnInit {
    ...
    constructor(
        ...
        this.event = localStorage.getItem("event_detail") ? JSON.parse(localStorage.getItem("event_detail")) : this.event_detail;
    ...
    ngOnInit(): void {
        ...
        // if ((this.event.isfullcompany == 'false') && (this.event.isfullgroup == 'false')) {
        //   this.loadUnitList_flag = false;
        //   this.dataSourceUnit.loadUnitDetail(0, 20, this.event.companyid, this.event.groupid, this.eventDetailService.current_eventID);
        // }
    ...
    onCompanyChange(event: any) {
        ...
        //   this.dataSourceUnit.loadUnitDetail(0, 20, current_companyID, '0', this.eventDetailService.current_eventID);
        // }
    }
        ...
        if (this.excludedSelection.selected.length == 0) {
            ...
            if (this.pageType == 'new') {
                if (this.neweventid != '') {
                    ...
                    this.eventDetailService.addMaintServiceToGroup(addData)
                        .subscribe((res: any) => {
    ...
    deleteItems() {
        if (this.includedSelection.selected.length == 0) {
            ...
            this.eventDetailService.deleteMaintServiceToGroup(deleteData)
                .subscribe((res: any) => {
                    if (res.TrackingXLAPI.DATA) {
