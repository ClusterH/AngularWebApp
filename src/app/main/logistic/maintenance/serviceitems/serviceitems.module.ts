...
import { ServiceitemDetailComponent} from 'app/main/logistic/maintenance/serviceitems/serviceitem_detail/serviceitem_detail.component';
import { ServiceitemDetailService } from 'app/main/logistic/maintenance/serviceitems/services/serviceitem_detail.service';
import { CourseDialogComponent } from 'app/main/logistic/maintenance/serviceitems/dialog/dialog.component';
...
@NgModule({
    ...
    providers: [
        ServiceitemsService, ServiceitemDetailService
    ]
})
