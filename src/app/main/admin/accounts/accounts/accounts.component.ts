...
import { AccountsService } from 'app/main/admin/accounts/services/accounts.service';
import { AccountsDataSource } from "app/main/admin/accounts/services/accounts.datasource";
import { AccountDetailService } from 'app/main/admin/accounts/services/account_detail.service';
import { AuthService } from 'app/authentication/services/authentication.service';

import {CourseDialogComponent} from "../dialog/dialog.component";
import { takeUntil } from 'rxjs/internal/operators';

import { locale as accountsEnglish } from 'app/main/admin/accounts/i18n/en';
import { locale as accountsSpanish } from 'app/main/admin/accounts/i18n/sp';
import { locale as accountsFrench } from 'app/main/admin/accounts/i18n/fr';
import { locale as accountsPortuguese } from 'app/main/admin/accounts/i18n/pt';
...
export class AccountsComponent implements OnInit
{
    ...
    constructor(
        private _adminAccountsService: AccountsService,
    ...
    ngOnInit(): void
    {
        ...
        this.dataSource = new AccountsDataSource(this._adminAccountsService);
    ...
    addNewAccount() {
        ...
        this.router.navigate(['admin/accounts/account_detail']);
    }
