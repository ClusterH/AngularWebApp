...
import { AccountDetail } from 'app/main/admin/accounts/model/account.model';
...
import { AccountDetailDataSource } from "app/main/admin/accounts/services/account_detail.datasource";
  ...
  saveAccount(): void {
    ...
    .subscribe((result: any) => {
      ...
      if (result.responseCode == 200) {
        alert("Success!");
        this.router.navigate(['admin/accounts/accounts']);
      }
    });
  }
