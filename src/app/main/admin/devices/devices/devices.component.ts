...
import { DevicesDataSource } from "app/main/admin/devices/services/devices.datasource";
import { DeviceDetailService } from 'app/main/admin/devices/services/device_detail.service';

import {CourseDialogComponent} from "../dialog/dialog.component";

import { locale as devicesEnglish } from 'app/main/admin/devices/i18n/en';
import { locale as devicesSpanish } from 'app/main/admin/devices/i18n/sp';
import { locale as devicesFrench } from 'app/main/admin/devices/i18n/fr';
import { locale as devicesPortuguese } from 'app/main/admin/devices/i18n/pt';
...
export class DevicesComponent implements OnInit
{
    ...
    constructor(
        private _adminDevicesService: DevicesService,
    ...
    ngOnInit(): void
    {
        ...
        this.dataSource = new DevicesDataSource(this._adminDevicesService);
    ...
    addNewDevice() {
        ...
        this.router.navigate(['admin/devices/device_detail']);
    }
