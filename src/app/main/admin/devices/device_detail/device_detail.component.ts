...
import { DeviceDetail } from 'app/main/admin/devices/model/device.model';
...
import { DeviceDetailDataSource } from "app/main/admin/devices/services/device_detail.datasource";
  ...
  saveDevice(): void {
    ...
    .subscribe((result: any) => {
      ...
      if (result.responseCode == 200) {
        alert("Success!");
        this.router.navigate(['admin/devices/devices']);
      }
    });
  }
