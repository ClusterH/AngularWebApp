...
export class EventDetailComponent implements OnInit, OnDestroy {
    ...
    @ViewChild('paginatorPoi', { read: MatPaginator }) paginatorPoi: MatPaginator;
    @ViewChild('paginatorZone', { read: MatPaginator }) paginatorZone: MatPaginator;
    ...
    ngOnInit(): void {
        ...
        if (this.event_detail.id != '0') {
            this.dataSourceEvCondition.loadEventCondition(this.event_detail.id);
        }
        this.dataSourceCompany.loadCompanyDetail(0, 10, this.event_detail.company, "company_clist");
        this.dataSourceGroup.loadGroupDetail(0, 10, this.event_detail.group, this.event_detail.companyid, "group_clist");

        if ((this.event_detail.isfullcompany == 'false') && (this.event_detail.isfullgroup == 'false')) {
            this.loadUnitList_flag = false;
            this.dataSourceUnit.loadUnitDetail(0, 20, this.event_detail.companyid, this.event_detail.groupid, this.event_detail.id);
        }
    ...
    loadEventDetail(method_string: string) {
        if (method_string == 'company') {
            ...
            this.dataSourcePoi.loadPoiZoneDetail(this.paginatorGroup.pageIndex, this.paginatorGroup.pageSize, this.filter_string, this.event.companyid, this.event.groupid, `${method_string}_clist`)
        } else if (method_string == 'zoneandgroup') {
            this.dataSourceZone.loadPoiZoneDetail(this.paginatorGroup.pageIndex, this.paginatorGroup.pageSize, this.filter_string, this.event.companyid, this.event.groupid, `${method_string}_clist`)
        } else if (method_string == 'digitalinput1') {
            this.dataSourceDigitalInput1.loadDigitalInputDetail(0, 1000, this.filter_string, 'digitalinput1_clist')
        } else if (method_string == 'digitalinput2') {
            this.dataSourceDigitalInput2.loadDigitalInputDetail(0, 1000, this.filter_string, 'digitalinput2_clist')
        }
    }
    ...
    onConditionChange(selected: any) {
        ...
        if (checkedCondition !== undefined) {
            ...
            if (this.ev_condition == 'EV_POI') {
                ...
                this.dataSourcePoi.loadPoiZoneDetail(0, 10, this.event.poi, this.event.companyid, this.event.groupid, "poiandgroup_clist");
                ...
                this.dataSourceZone.loadPoiZoneDetail(0, 10, this.event.zone, this.event.companyid, this.event.groupid, "zoneandgroup_clist");
                ...
                this.dataSourceDigitalInput1.loadDigitalInputDetail(0, 1000, '', "digitalinput1_clist");
                this.dataSourceDigitalInput2.loadDigitalInputDetail(0, 1000, '', "digitalinput2_clist");
                let inputon1: number;
                let inputon2: number;
                let count: number
                count = 0
    ...
    onCompanyChange(event: any) {
        ...
        if (this.loadUnitList_flag == false) {
            this.dataSourceUnit.loadUnitDetail(0, 20, current_companyID, '0', this.event.id);
        }
    }
    ...
    onGroupChange(event: any) {
        ...
        if (this.loadUnitList_flag == false) {
            this.dataSourceUnit.loadUnitDetail(0, 20, current_companyID, current_groupID, this.event.id);
        }
    }
    ...
    setValues() {
        ...
        if (this.event.isspeed == 'true') {
            ...
            this.eventForm.get('speedinput').setValue(this.event.speed ? this.event.speed : 0);
    ...
    saveEvCondition(evcode: string, param: any, type: string) {
        ...
        if (evcode != '') {
            this.eventDetailService.saveEvCondition(param).pipe(takeUntil(this._unsubscribeAll))
                .subscribe((res: any) => {
                                ...
                                this.eventDetailService.saveEventDetail(this.event_detail).pipe(takeUntil(this._unsubscribeAll))
                                    .subscribe((result: any) => {
                                        if ((result.responseCode == 200) || (result.responseCode == 100)) {
                                            this.dataSourceEvCondition.loadEventCondition(result.TrackingXLAPI.DATA[0].id);
                                            this.dataSourceEvCondition.eventsSubject.next(this.eventDetailService.eventConditionList);
                                            this.flag.next(true);
                                        }
                                    });
    ...
    paginatorClick(paginator) {
        this.dataSourceUnit.loadUnitDetail(paginator.pageIndex, paginator.pageSize, this.event.companyid, this.event.groupid, this.event.id);
    }

    locationPagenation(paginator) {
        if (this.ev_condition == 'EV_POI') {
            this.dataSourcePoi.loadPoiZoneDetail(paginator.pageIndex, paginator.pageSize, this.event.poi, this.event.companyid, this.event.groupid, "poiandgroup_clist");
        } else if (this.ev_condition == 'EV_ZONE') {
            this.dataSourceZone.loadPoiZoneDetail(paginator.pageIndex, paginator.pageSize, this.event.zone, this.event.companyid, this.event.groupid, "zoneandgroup_clist");
        } else if (this.ev_condition == 'EV_SENSOR') {
            this.dataSourceZone.loadDigitalInputDetail(0, 1000, '', "digitalinput_clist");
        }
    }
}