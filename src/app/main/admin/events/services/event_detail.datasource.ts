...
export class EventDetailDataSource extends DataSource<any>
{
    ...
    loadUnitDetail(conncode: string, userid: number, pageindex: number, pagesize: number, companyid: number, groupid: number, eventid: number) {
    ...
    loadEventCondition(conncode: string, userid: number, eventid: number) {
