...
import { UnittypesDataSource } from "app/main/admin/unittypes/services/unittypes.datasource";
...
export class UnittypesComponent implements OnInit
{
    ...
    ngOnInit(): void
    {
        ...
        this.dataSource = new UnittypesDataSource(this._adminUnittypesService);
