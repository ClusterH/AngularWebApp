...
export class ZonegroupsComponent implements OnInit {
    ...
    ngAfterViewInit() {
        ...
        merge(this.sort.sortChange, this.paginator.page)
            .pipe(tap(() => this.dataSource.loadZonegroups(this.paginator.pageIndex, this.paginator.pageSize, this.sort.active, this.sort.direction, this.selected, this.filter_string, "Zonegroup_Tlist"))
            )
            .subscribe((res: any) => {
            });
    ...
    selectedFilter() {
        ...
        if (this.selected == '') {
            ...
            this.dataSource.loadZonegroups(this.paginator.pageIndex, this.paginator.pageSize, this.sort.active, this.sort.direction, this.selected, this.filter_string, "Zonegroup_Tlist");
        }
    }

    actionPageIndexbutton(pageIndex: number) {
        this.dataSource.loadZonegroups(pageIndex, this.paginator.pageSize, this.sort.active, this.sort.direction, this.selected, this.filter_string, "Zonegroup_Tlist");
    }
