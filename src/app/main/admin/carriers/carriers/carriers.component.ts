...
import { CarriersDataSource } from "app/main/admin/carriers/services/carriers.datasource";
...
export class CarriersComponent implements OnInit
{
    ...
    ngOnInit(): void
    {
        ...
        this.dataSource = new CarriersDataSource(this._adminCarriersService);
