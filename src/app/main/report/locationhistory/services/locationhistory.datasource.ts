...
export class LocationHistoryDataSource extends DataSource<any>
{
    ...
    loadReport(conncode: string, userid: number, pageindex: number, pagesize: number, categoryid: number, filterString: string, method: string) {
        console.log("loadVehicles:", conncode, userid,  pagesize, pageindex, filterString, method );
        this.loadingSubject.next(true);
   
        // use pipe operator to chain functions with Observable type
        this.locationhistoryService.getReports(conncode, userid, pageindex, pagesize, categoryid, filterString, method)
        .pipe(
           catchError(() => of([])),
