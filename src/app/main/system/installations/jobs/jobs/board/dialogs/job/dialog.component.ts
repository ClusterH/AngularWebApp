...
export class JobCardDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<JobCardDialogComponent>,
        ...
        this.installerName = _data.installerName;

        if (this.flag == 'edit') {
            // this.jobsService.getInstallationDetail(_data.cardId).pipe(takeUntil(this._unsubscribeAll)).subscribe(res => {
            //
            //     this.job = res.TrackingXLAPI.DATA[0];
            // });
    ...
    ngOnInit() {
        ...
        this.jobForm = this._formBuilder.group({
            ...
            installer: [{ value: null, disabled: true }],
    ...
    setValues() {
        ...
        this.jobForm.get('installer').setValue(this.installerName.name);
    ...
    getValue() {
        ...
        this.serviceDetail.installerid = this.installerName.id;
            ...
            if (this.flagForSaving) {
                ...
                this.jobsService.saveJob(this.serviceDetail).pipe(takeUntil(this._unsubscribeAll)).subscribe((res: any) => {
                    ...
                    if ((res.responseCode == 200) || (res.responseCode == 100)) {
                        ...
                        this.flagForSaving.next(false);
                        this.serviceDetail.id = res.TrackingXLAPI.DATA[0].id;
                        this.dialogRef.close(this.serviceDetail);
                        // this.dialogRef.close(this.jobsService.jobList);
                    } else {
                        alert('Failed adding!');
                    }
    ...
    getNewvalue() {
        ...
        this.serviceDetail.deletedby = this.job.deletedby || '';
        this.serviceDetail.deletedwhen = this.job.deletedwhen || '';
        this.serviceDetail.longitude = this.job.longitude || '0';
        this.serviceDetail.latitude = this.job.latitude || '0';
        this.serviceDetail.scheduledate = this.job.scheduledate || '';
        this.serviceDetail.created = this.job.created || '';
        this.serviceDetail.createdby = this.job.createdby || '';
        this.serviceDetail.customername = this.jobForm.get('customer').value;
