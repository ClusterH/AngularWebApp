...
export class PrivilegeDetailDataSource extends DataSource<any>
{
    ...
    loadPrivilegeDetail(conncode: string, userid: number, pageindex: number, pagesize: number, name: string, method: string) {
        ...
        this.privilegeDetailService.getCompanies(conncode, userid, pageindex, pagesize, name,  method)
        .pipe(
           catchError(() => of([])),
