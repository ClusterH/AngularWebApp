...
@Injectable()
export class FuelregistriesService
{
    fuelregistries: any[];
    fuelregistryList: any;
    ...
    getFuelregistries(conncode: string, userid: number, pageindex: number, pagesize: number, orderby: string, orderdirection: string, filterItem: string, filterString: string, method: string): Observable<any>
    {
